<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockStatus.aspx.cs" Inherits="Test.StockStatus" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnDownloadSSRStore" runat="server" Text="Download-SSR-Store" style="width: 152px;"   ClientIDMode="Static" Visible="false" OnClick="btnDownloadSSRStore_Click"/>

                    &nbsp;<asp:Button ID="btnDownloadLCPStore" runat="server" Text="Download-LCP-Store" style="width: 150px;"  ClientIDMode="Static" Visible="false" OnClick="btnDownloadLCPStore_Click" />

                    &nbsp;<asp:Button ID="btnDownloadWssi" runat="server" Text="Download-Wssi" style="width: 125px;"  ClientIDMode="Static" Visible="false" OnClick="btnDownloadWssi_Click" />
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnWssiDivision" runat="server" Text="Download-WSSI Division" style="width: 170px;"   ClientIDMode="Static" Visible="False" OnClick="btnWssiDivision_Click" />
                    
                     &nbsp;<asp:Button ID="btnPGCompare" runat="server" Text="Download-PG Compare" style="width: 160px;"   ClientIDMode="Static" Visible="false" OnClick="btnPGCompare_Click" />

                     &nbsp;<asp:Button ID="btnWssiPg" runat="server" Text="Download-WSSI Pg" style="width: 160px;"   ClientIDMode="Static" Visible="false" OnClick="btnWssiPg_Click"  />
