         ...
         <tr>
            ...
            <td>
                 <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="17" Text="Outward"></asp:ListItem>
                   </asp:DropDownList>
            </td>
        </tr>
         ...
         <tr id="trStoreNo" runat="server" visible="false">
          ...
          <tr id="trInwardSelectFile" runat="server" visible="false">
           ...
           <tr id="trSelectDoc" runat="server" visible="false">
              ...
              <td>
                  <asp:RadioButtonList ID="rdlSelectDoc"  runat="server" RepeatDirection="Horizontal" >
          ...
          <tr>
            ...
            <td>
                  <asp:Button ID="btnExport" style="width: 100px;" runat="server" Text="Export" OnClick="btnExport_Click"/>
                  &nbsp;&nbsp;
