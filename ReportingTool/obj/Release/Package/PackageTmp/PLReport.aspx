<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PLReport.aspx.cs" Inherits="ReportingTool.PLReport" %>
    ...
    <table style="width: 100%;" border="0">
        <tr>
            <td class="text-admin-panel" width="20%">
                Profit And Loss Report Matalan
            </td>
            <td>
    ...
    <table>
          ...
          <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOmanRate" runat="server" Text="9.38" ></asp:TextBox>
