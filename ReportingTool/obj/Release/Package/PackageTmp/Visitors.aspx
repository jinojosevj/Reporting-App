<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Visitors.aspx.cs" Inherits="Test.Visitors" %>
        ...
        <tr>
            ...
            <td>
               ...
               &nbsp;&nbsp; <asp:Button ID="btnDownloadWeekly" runat="server" Text="Download Weekly" Visible="false" Style="width:132px;" OnClick="btnDownloadWeekly_Click"/>
                ...
                &nbsp;&nbsp; <asp:Button ID="btnVisitorsVsSales" runat="server" Text="Visitors Vs Sales" Visible="false" Style="width:132px;" OnClick="btnVisitorsVsSales_Click" />
            </td>
        </tr>
