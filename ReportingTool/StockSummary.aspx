<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockSummary.aspx.cs" Inherits="ReportingTool.StockSummary" %>
    ...
    <table  style="width:100%; border:0">
        ...
        <tr>
            ...
            <td>
                   ...
                   &nbsp; <asp:Button ID="btnDownload" runat="server" Text="Stock Summary Report" style="width: 165px;"  Visible="false" ClientIDMode="Static" OnClick="btnDownload_Click"/>
