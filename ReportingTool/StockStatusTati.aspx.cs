...
{
    public partial class StockStatusTati : System.Web.UI.Page
    {
        ...
        #region btnSSRMY_Click
        /// <summary>
        /// btnSSRMY_Click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnSSRMY_Click(object sender, EventArgs e)
        {
            string filename = ViewState["FileNameMY"].ToString();
            FileDownload(filename);
        }

        #endregion btnSSRMY_Click
        ...
        #region btnLCPMY_Click
        /// <summary>
        /// btnLCPMY_Click
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnLCPMY_Click(object sender, EventArgs e)
        {
            string filename = ViewState["FileNameMYLCP"].ToString();
            FileDownload(filename);
        }
        #endregion btnLCPMY_Click
        ...
        private void GenerateReport()
        {
            ...
            string fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\StockStatusReportTati.xlsx";
            ...
            if (txtLocation.Text.Trim().Length > 0)
            {
                ...
                fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\StockStatusReportOneTati.xlsx";
                myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
            ...
            else
            {
                ...
                Excel1.Worksheet xlSheetSummery = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];
                ...
                dtStock = objStock.GetAllStockValues("4728");
                ...
                dtStock = objStock.GetAllStockValues("4729");
                ...
                dtStock = objStock.GetAllStockValues("4731");
            ...
            string filePath = Server.MapPath(".") + "\\Reports\\SSR_TATI_" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + "_" + rnd.Next() + ".xlsx";
        ...
        private void GenerateReportMY()
        {
            ...
            string fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\MYStockStaus.xlsx";
            myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
            ...
            if (txtLocation.Text.Trim().Length > 0)
            {
                ...
                fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\MYStockStaus.xlsx";
                myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
                Excel1.Worksheet xlSheet = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];

                dtStock = objStock.GetAllStockValuesMY(location);
            ...
            else
            {
                ...
                Excel1.Worksheet xlSheetSummery = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];
                xlSheetSummery.Name = "Summery";
                dtStock = objStock.GetAllStockValuesMY("Summery");
                WriteToExcel(dtStock, xlSheetSummery, "Summery");

                Excel1.Worksheet xlSheetF004 = (Excel1.Worksheet)myExcelWorkbook.Sheets[2];
                xlSheetF004.Name = "F004";
                dtStock = objStock.GetAllStockValuesMY("F004");
                WriteToExcel(dtStock, xlSheetF004, "F004");

                Excel1.Worksheet xlSheetF007 = (Excel1.Worksheet)myExcelWorkbook.Sheets[3];
                xlSheetF007.Name = "F007";
                dtStock = objStock.GetAllStockValuesMY("F007");
                ...
                lblMessage.ForeColor = System.Drawing.Color.Green;
                lblMessage.Text = "Report Generation Complete";
                btnSSRMY.Visible = true;
                // btnDownloadSSRStore.Visible = true;

            }

            Random rnd = new Random();
            string filePath = Server.MapPath(".") + "\\Reports\\SSR_MY_" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + "_" + rnd.Next() + ".xlsx";
        ...
        private void WriteToExcel(DataTable dtStock, Excel1.Worksheet myExcelWorksheet, string location)
        {
            ...
            for (int i = 0, j = 0; i < dtStock.Rows.Count; i++, j++)
            {
                 ...
                 if (dtStock.Rows[i]["ReportLevel"].ToString() == "LD" && dtStock.Rows[i]["LocationCode"].ToString() == "F004" && flag != 1)
                {
                    flag = 1;
                    ...
                    myExcelWorksheet.get_Range("A" + (j + 5), misValue).Formula = "Division-Category";
                ...
                else if (dtStock.Rows[i]["ReportLevel"].ToString() == "LD" && flag != 1)
                {
                    flag = 1;
                ...
                else if (dtStock.Rows[i]["ReportLevel"].ToString() == "LSDC" && flag != 2)
                {
                    flag = 2;
                    ...
                    myExcelWorksheet.get_Range("A" + (j + 5), misValue).Formula = "Season-Division-Category";
                    myExcelWorksheet.get_Range("A" + (j + 5), misValue).Font.Bold = true;
                    myExcelWorksheet.get_Range("A" + (j + 5), misValue).Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.DarkBlue);
                    j += 3;
                    i -= 1;
                ...
                else
                {
                    ...
                    switch (SeasonCode)
                    {
                        case "1": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "READY TO WEAR";
                            break;
                        case "2": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "LINGERY";
                            break;
                        case "3": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "ACCESSORIES & SHOES";
                            break;
                        case "4": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "WEDDING";
                            break;
                        case "5": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "HOME & LEISURE";
                            break;
                        case "6": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "HYGIENE";
                            break;
                        case "8": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "SERVICES";
                            break;
                        case "8888": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "TRASH";
                            break;
                        case "99": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "LOT";
                            break;
                        case "9999": myExcelWorksheet.get_Range("A" + (j + 4), misValue).Formula = "FURNITURE";
                            break;
        ...
        private void GenerateReportLCP()
        {
            ...
            string fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\StockStatus_LCPTati.xlsx";
            myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
            ...
            if (txtLocation.Text.Trim().Length > 0)
            {
                ...
                fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\StockStatus_LCPTatiOne.xlsx";
                myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
                Excel1.Worksheet xlSheet = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];
            ...
            else
            {
                ...
                Excel1.Worksheet xlSheet4728 = (Excel1.Worksheet)myExcelWorkbook.Sheets[2];
                xlSheet4728.Name = "4728";
                dtStock = objStock.GetAllStockValuesLCP("4728");
                WriteToExcelLCP(dtStock, xlSheet4728, "4728");


                Excel1.Worksheet xlSheet4729 = (Excel1.Worksheet)myExcelWorkbook.Sheets[3];
                xlSheet4729.Name = "4729";
                dtStock = objStock.GetAllStockValuesLCP("4729");
                WriteToExcelLCP(dtStock, xlSheet4729, "4729");

                Excel1.Worksheet xlSheet4731 = (Excel1.Worksheet)myExcelWorkbook.Sheets[4];
                xlSheet4731.Name = "4731";
                dtStock = objStock.GetAllStockValuesLCP("4731");
                WriteToExcelLCP(dtStock, xlSheet4731, "4731");
            ...
            Random rnd = new Random();
            string filePath = Server.MapPath(".") + "\\Reports\\SSR_LCP_Tati_" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + "_" + rnd.Next() + ".xlsx";
        ...
        private void WriteToExcelLCPSummery(DataTable dtStock, Excel1.Worksheet myExcelWorksheet)
        {
            ...
            for (int i = 0, j = 0; i < dtStock.Rows.Count; i++, j++)
            {
                ...
                if (dtStock.Rows[i]["CategoryCode"].ToString() == "Total")
                {
                    ...
                    if (Convert.ToInt32(dtStock.Rows[i]["4728"]) != 0)
                    {
                        myExcelWorksheet.get_Range("V" + (j + 3), misValue).Formula = dtStock.Rows[i]["4728"].ToString();
                    ...
                    else if (Convert.ToInt32(dtStock.Rows[i]["4729"]) != 0)
                    {
                        myExcelWorksheet.get_Range("W" + (j + 3), misValue).Formula = dtStock.Rows[i]["4729"].ToString();
                    ...
                    else if (Convert.ToInt32(dtStock.Rows[i]["4731"]) != 0)
                    {
                        myExcelWorksheet.get_Range("X" + (j + 3), misValue).Formula = dtStock.Rows[i]["4731"].ToString();
                ...
                else
                {
                    ...
                    myExcelWorksheet.get_Range("V" + (j + 3), misValue).Formula = (null != dtStock.Rows[i]["4728"]) ? dtStock.Rows[i]["4728"].ToString() : "0";
                    BorderAround(myExcelWorksheet.get_Range("V" + (j + 3), misValue), System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Black));

                    myExcelWorksheet.get_Range("W" + (j + 3), misValue).Formula = (null != dtStock.Rows[i]["4729"]) ? dtStock.Rows[i]["4729"].ToString() : "0";
                    BorderAround(myExcelWorksheet.get_Range("W" + (j + 3), misValue), System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Black));

                    myExcelWorksheet.get_Range("X" + (j + 3), misValue).Formula = (null != dtStock.Rows[i]["4731"]) ? dtStock.Rows[i]["4731"].ToString() : "0";
                    BorderAround(myExcelWorksheet.get_Range("X" + (j + 3), misValue), System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.Black));
        ...
        #region GenerateReportLCPMY
        /// <summary>
        /// To generate excel report for stock values LCP
        /// </summary>
        private void GenerateReportLCPMY()
        {
            ...
            string fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\MYStockStatusLCP.xlsx";
            myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
            ...
            if (txtLocation.Text.Trim().Length > 0)
            {
                ...
                fileName = HttpContext.Current.Server.MapPath(".") + "\\Template\\MYStockStatusLCP.xlsx";
                myExcelWorkbook = myExcelWorkbooks.Open(fileName, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue, misValue);
                Excel1.Worksheet xlSheet = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];

                dtStock = objStock.GetStockStatusLCPMY(location);
            ...
            else
            {
                ...
                Excel1.Worksheet xlSheetSummery = (Excel1.Worksheet)myExcelWorkbook.Sheets[1];
                xlSheetSummery.Name = "Summery";
                dtStock = objStock.GetStockStatusLCPMY("Summery");
                WriteToExcelLCP(dtStock, xlSheetSummery, "Summery");

                Excel1.Worksheet xlSheetF004 = (Excel1.Worksheet)myExcelWorkbook.Sheets[2];
                xlSheetF004.Name = "F004";
                dtStock = objStock.GetStockStatusLCPMY("F004");
                WriteToExcelLCP(dtStock, xlSheetF004, "F004");

                Excel1.Worksheet xlSheetF007 = (Excel1.Worksheet)myExcelWorkbook.Sheets[3];
                xlSheetF007.Name = "F007";
                dtStock = objStock.GetStockStatusLCPMY("F007");
                 if(dtStock.Rows.Count>0)
                   WriteToExcelLCP(dtStock, xlSheetF007, "F007");
                    ...
                    //lblMessage.ForeColor = System.Drawing.Color.Green;
                    //lblMessage.Text = "Report Generation Complete";
                    btnLCPMY.Visible = true;
                // btnDownloadLCPStore.Visible = true;

            }

            Random rnd = new Random();
            string filePath = Server.MapPath(".") + "\\Reports\\SSR_LCP_MY_" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + "_" + rnd.Next() + ".xlsx";

            ViewState["FileNameMYLCP"] = filePath;
            myExcelWorkbook.SaveAs(@filePath);
        ...
        private void GeneratePgCmpReport()
        {
            ...
            else
            {
                ...
                Excel1.Worksheet xlSheet0422 = (Excel1.Worksheet)myExcelWorkbook.Sheets[25];
                xlSheet0422.Name = "JORDAN";
                objStock.Location = "JORDAN";
                dtStock = objStock.GetPgCmpReport();
                WriteToExcelPgCmp(dtStock, xlSheet0422);

                Excel1.Worksheet xlSheet0423 = (Excel1.Worksheet)myExcelWorkbook.Sheets[26];
                xlSheet0423.Name = "UAE";
                objStock.Location = "UAE";
                dtStock = objStock.GetPgCmpReport();
                WriteToExcelPgCmp(dtStock, xlSheet0423);

                Excel1.Worksheet xlSheet0424 = (Excel1.Worksheet)myExcelWorkbook.Sheets[27];
                ...
                Excel1.Worksheet xlSheet0425 = (Excel1.Worksheet)myExcelWorkbook.Sheets[28];
                ...
                Excel1.Worksheet xlSheet0428 = (Excel1.Worksheet)myExcelWorkbook.Sheets[29];
