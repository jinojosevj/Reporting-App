<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockStatusVAT.aspx.cs" Inherits="ReportingTool.StockStatusVAT" %>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:Button ID="btnDownload" runat="server" Text="Download-SSR" style="width: 110px;"   ClientIDMode="Static" Visible="false"/>

                    &nbsp;<asp:Button ID="btnDownloadLCP" runat="server" Text="Download-LCP" style="width: 110px;"  ClientIDMode="Static" Visible="false" />
