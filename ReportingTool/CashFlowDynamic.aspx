<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CashFlowDynamic.aspx.cs" Inherits="ReportingTool.CashFlowDynamic" %>
    ...
    <table>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                <asp:RadioButtonList ID="RdlRefresh" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem  Selected="True" Value="0">Refresh With Report</asp:ListItem>
                        <asp:ListItem Value="1">Refresh Only</asp:ListItem>
        ...
        <tr>
                ...
                <td>
                    ...
                    <asp:CheckBox ID="chkCashFlow" Text="Cash Flow" Checked="true" runat="server" />
                    <asp:CheckBox ID="chkProfitLoss" Text="Profit Loss" Checked="true" runat="server" />
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;<asp:Button ID="btnProfitLoss" runat="server" Text="Profit & Loss" style="width: 120px;" ValidationGroup="GenerateReport" ClientIDMode="Static" Visible="False" OnClick="btnProfitLoss_Click"  />
